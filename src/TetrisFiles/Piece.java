    ...
    public void randomPiece() {
        ...
        switch (a) {
            case 0:
                ...
                block4 = new Block(300, 100, 0, this.root, this.game);
            ...
            case 1:
                ...
                this.members[2] = block3;
                block4 = new Block(250, 50, 1, this.root, this.game);
                this.members[3] = block4;
                break;
            ...
            case 3:
                ...
                this.members[0] = block1;
                block2 = new Block(250, 50, 3, this.root, this.game);
                this.members[1] = block2;
                block3 = new Block(200, 0, 3, this.root, this.game);
                this.members[2] = block3;
                block4 = new Block(300, 50, 3, this.root, this.game);
                this.members[3] = block4;
                break;
            ...
            case 4:
                ...
                this.members[2] = block3;
                block4 = new Block(250, 50, 4, this.root, this.game);
                this.members[3] = block4;
                break;
            ...
            case 5:
                ...
                this.members[0] = block1;
                block2 = new Block(250, 50, 5, this.root, this.game);
                this.members[1] = block2;
                block3 = new Block(250, 100, 5, this.root, this.game);
                this.members[2] = block3;
                block4 = new Block(250, 150, 5, this.root, this.game);
                this.members[3] = block4;
                break;
            ...
            case 6:
                ...
                this.members[2] = block3;
                block4 = new Block(250, 100, 6, this.root, this.game);
                this.members[3] = block4;
                break;
        }
    }
